...
theorem clustering_guarantee : ClusteringGuarantee := by
  ...
  refine ⟨4096, collisionCap η₀ populations indecisionLimit εcov δ α pAP,
    stoppable η₀ populations indecisionLimit εcov δ α pAP
      (collisionCap η₀ populations indecisionLimit εcov δ α pAP)
      (collisionCap η₀ populations indecisionLimit εcov δ α pAP),
    ?_, ?_, ?_⟩
  · sorry
  · sorry
